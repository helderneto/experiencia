...
function vRPhk.docsOnline()
  local docs = vRP.getUsersByPermission({"coma.emergency"})
  return #docs
end
...
function vRPhk.helpComa(x,y,z)
  vRP.sendServiceAlert({source,"emergency",x,y,z,"Ajuda! Estou em coma!"}) -- people will change this message anyway haha
end
