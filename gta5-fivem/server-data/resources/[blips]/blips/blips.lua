 local blips = {
 	...
 	{title="Hacker", colour=49, id=362, x = 705.67150878906, y = -966.78765869141, z = 30.395341873169},
 	...
 	{title="Centro de Emprego", colour=47, id=351, x = -1911.9273681641, y = -569.71649169922, z = 19.097215652466}, -- CoC
 	{title="PSP", colour=38, id=351, x = 447.35137939453, y = -975.57592773438, z = 30.689584732056}, -- Mission Row
 	...
 	{title="Traficante de Armas", colour=2, id=351, x = 283.10546875, y = 6788.7104492188, z = 15.695198059082}, -- Weapons Smuggler
 	...
 	{title="Juiz", colour=7, id=351, x = -59.127178192139, y = 359.25082397461, z = 113.05643463135}, -- Judge
 	{title="Falsificador", colour=2, id=351, x = 959.64337158203, y = 3619.0256347656, z = 32.668811798096}, -- Forger
	...
	{title="Empresas", colour=2, id=431, x = 639.78234863282, y = 2773.1804199218, z = 42.025310516358}
   }
