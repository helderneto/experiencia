INTERIORS = {
    -- HOPITAL
    [1] = {id = 1, x = 360.08847045898, y = -585.16223144531, z = 28.820465087891,  name = "Sair do Hospital", destination = {2}},
	[2] = {id = 2, x = 251.32405090332, y = -1367.2664794922, z = 39.534370422363,  name = "Entrar no Hospital", destination = {1}},
	[10] = {id = 10, x = 338.84991455078, y = -583.84454345703, z = 74.165725708008,  name = "Sair do Telhado", destination = {11}},
	[11] = {id = 11, x = 246.4398651123, y = -1384.7005615234, z = 39.534378051758,  name = "Telhado", destination = {10}},
