...
items["weed"] = {"Erva","Erva do mato.",function(args) return smoke_choices end,0.10}
items["cocaine"] = {"Cocaina","Po milagroso.",function(args) return smell_choices end,0.5}
items["lsd"] = {"LSD","LSD puro.",function(args) return lsd_choices end,0.1}
items["Medical Weed"] = {"Medicamnetos","Usado pelos Medicos."}
