...
local itemtr_hacker = {
  ...
  recipes = {
    ...
    --},
	["hacking"] = { -- action name
      description="Hackear Cartoes de Credito", -- action description
      in_money=0, -- money taken per unit
      out_money=0, -- money earned per unit
      reagents={}, -- items taken per unit
      products={
  ...
  ["mansion2"] = {
    {
	  ...
	  --{"itemtr", _config = itemtr_hacker, 3.5792558193207,529.89599609375,174.6280670166}
    }
  },
  ["beach_house"] = {
    {
