...
cfg.item_transformers = {
 ...
 -- {
  ...
  },
  {
    ...
    recipes = {
      ["Forca"] = { -- action name
        description="Aumenta a tua Forca.", -- action description
        in_money=0, -- money taken per unit
        out_money=0, -- money earned per unit
        reagents={}, -- items taken per unit
        products={}, -- items given per unit
  ...
  },
  {
    ...
    max_units=500,
    units_per_minute=4,
    x=1008.0462036133,y=-3169.8435058594,z=-38.894435882568,
    radius=2, height=1.0, -- area
    recipes = {
      ["hacking"] = { -- action name
        description="Hacking Cartoes de Credito.", -- action description
        in_money=0, -- money taken per unit
        out_money=0, -- money earned per unit
        reagents={}, -- items taken per unit
        products={
  ...
  },
  {
    ...
    radius=2, height=1.0, -- area
    recipes = {
      ["Falsificar"] = { -- action name
        description="Falsificar ID's", -- action description
        in_money=0, -- money taken per unit
        out_money=0, -- money earned per unit
        reagents={
		["credit"] = 1
  ...
  },
  {
    ...
    radius=2, height=1.0, -- area
    recipes = {
      ["Carta de Conducao"] = { -- action name
       description="Comprar Carta de Conducao.", -- action description`
 ...
 -- },
  {
    ...
    recipes = {
      ...
      ["weed"] = { -- action name
        description="Produzir weed", -- action description
        in_money=500, -- money taken per unit
        out_money=0, -- money earned per unit
        reagents={ -- items taken per unit
          ["seeds"] = 1
      ...
      ["lsd"] = { -- action name
          description="Produzir LSD", -- action description
          in_money=500, -- money taken per unit
          out_money=0, -- money earned per unit
          reagents={ -- items taken per unit
            ["harness"] = 1
...
cfg.hidden_transformers = {
  ["weed field"] = {
    def = {
      ...
      recipes = {
        ["Harvest"] = { -- action name
          description="Recolher weed.", -- action description
          in_money=0, -- money taken per unit
          out_money=0, -- money earned per unit
          reagents={}, -- items taken per unit
          products={ -- items given per unit
    ...
    positions = {
      {1057.8697509766,-3196.3276367188,-39.161266326904}
    }
  },
  ["cocaine dealer"] = {
    def = {
    ...
    positions = {
      {1090.1893310547,-3199.0529785156,-38.993469238281}
    }
  },
  ["lsd bar"] = {
    def = {
    ...
    positions = {
      {1017.1154174805,-3196.2514648438,-38.993125915527}
    }
  },
  ["police1"] = {
    def = {
