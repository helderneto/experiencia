...
function startttest()
        if theorylock then
			DrawMissionText2("~r~Trancado", 5000)			
		else
...
function EndDTest()
        if Error > maxErrors then
			drawNotification("Erraste\nAcumulaste ".. Error.." ~r~Erros")
			onPtest = false
			EndTestTasks()
		else
			--local licID = 1
...
function DIntro()
	...
	DTutOpen = true
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "<b style='color:#1E90FF'>Introdução</b> <br /><br />O teste teórico e o prático são importantes para uma boa condução.<br />Estes testes reúnem todas as informações essenciais para ter uma boa conduta, tanto como na forma de conduzir como na forma de agir.<br /><br />As informações de suas lições de teoria combinadas com a experiência de sua lição prática são vitais para negociar as situações e dilemas que você enfrentará na estrada.<br /><br />Sente-se e aproveite o passeio quando começamos. É altamente recomendável que você preste atenção em todos os detalhes, a maioria dessas questões pode existir no seu teste teórico.",
            type = "alert",
            timeout = (15000),
            layout = "center",
            queue = "global"
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "<b style='color:#1E90FF'>Acidentes, incidentes e preocupações ambientais</b><br /><br /><b style='color:#87CEFA'>Dever de render</b><br />Todos os condutores têm o dever de obedecer as regras de a estrada, a fim de evitar danos previsíveis aos outros. A falha em ceder o direito de passagem quando exigido por lei pode resultar em responsabilidade por qualquer acidente resultante.<br /><br /> Quando você ouve uma sirene chegar, você deve ceder ao veículo de emergência, simplesmente puxar para a direita.<br />Você deve parar sempre quando um oficial de trânsito lhe disser. <br /><br /><b style='color:#87CEFA'>Condução agressiva</b><br />Um carro que põe em perigo ou é susceptível de pôr em perigo as pessoas ou a propriedade é considerada uma condução agressiva<br />No entanto, a condução agressiva pode levar a acidentes trágicos. É muito mais sábio dirigir defensivamente e sempre estar atento ao risco potencial de falhas.<br />",
            type = "alert",
            timeout = (15000),
            layout = "center",
            queue = "global"
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "<b style='color:#1E90FF'>Área residencial</b> <br /><br />Mantenha uma velocidade apropriada - Nunca mais rápido que o limite postulado, mais lento se o tráfego for pesado.<br /><br />Mantenha-se centrado na sua pista. Nunca conduza na área reservada para carros estacionados.<br /><br />Mantenha uma distância segura de seguimento - pelo menos 1 metro comprimento de carro por cada 5 metros.<br /><br /><br />",
            type = "alert",
            timeout = (15000),
            layout = "center",
            queue = "global"
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "<b style='color:#1E90FF'>Áreas / cidades urbanas</b> <br /><br />O limite de 80 km / h geralmente se aplica a todo o tráfego em todas as estradas com iluminação pública, a menos que especificado de outra forma.<br />Condução em velocidades muito rápidas para a A estrada e as condições de condução podem ser perigosas.<br /><br />Você sempre deve reduzir sua velocidade quando:<br /><br />&bull; Compartilhando a estrada com pedestres<br />&bull; Dirigindo à noite, pois é mais difícil ver outros usuários da estrada<br />&bull; As condições meteorológicas tornam mais seguro fazê-lo<br /><br />Lembre-se, veículos grandes e motocicletas precisam de uma distância maior para parar<br />",
            type = "alert",
            timeout = (15000),
            layout = "center",
            queue = "global"
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "<b style='color:#1E90FF'>Auto-estradas</b> <br /><br />O tráfego nas auto-estradas geralmente viaja mais rápido do que em outras estradas, então você tem menos tempo para reagir.<br />É especialmente importante usar suas imagens anteriormente e olhar muito mais à frente do que você faria em outras estradas.<br /><br />Verifique o tráfego na auto-estrada e combine sua velocidade para caber em segurança no fluxo de tráfego na pista esquerda.<br /><br />O limite de velocidade em uma área de auto-estrada / rodovia é de 120 km / h.<br />",
            type = "alert",
            timeout = (15000),
            layout = "center",
            queue = "global"
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "<b style='color:#1E90FF'>Álcool </b> <br /><br />Beber ao dirigir é muito perigoso, álcool e / ou drogas prejudicam seu julgamento. O julgamento prejudicado afeta a forma como você reage aos sons e ao que vê. No entanto, a Escola de Condução permite uma certa quantidade de concentração de álcool para aqueles que conduzem com uma licença de motorista válida.<br /><br />0,08% é o limite legal para a concentração de álcool no sangue de um motorista.<br />",
            type = "alert",
            timeout = (15000),
            layout = "center",
            queue = "global"
...
function DTut()
	...
	DTutOpen = true
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "<b style='color:#1E90FF'>Instrutor:</b> <br /><br /> Estamos atualmente preparando seu veículo para o teste, enquanto você deve ler algumas linhas importantes.<br /><br /><b style='color:#87CEFA'>Limite de velocidade:</b><br /> - Preste atenção ao tráfego e fique abaixo da <b style='color:#A52A2A'>velocidade</b> limite <br /><br />- Agora, você deve saber o básico, no entanto, tentaremos lembrá-lo sempre que você <b style='color:#DAA520'>entrar/sair</b> uma área com um limite de velocidade postado.",
            type = "alert",
            timeout = (15000),
            layout = "center",
            queue = "global"
		...
		Citizen.Wait(16500)
		TriggerEvent("pNotify:SendNotification",{
            text = "<b style='color:#1E90FF'>Instrutor:</b> <br /><br /> Use o recurso <b style='color:#DAA520'>Cruise Control</b> para evitar <b style='color:#87CEFA'>excesso de velocidade</b>, ative isso durante o teste pressionando o botão <b style='color:#20B2AA'>X</b> no seu teclado.<br /><br /><b style='color:#87CEFA'>Avaliação:</b><br />- Tente não parar o veículo ou superar o limite de velocidade publicado. Você receberá <b style='color:#A52A2A'>Pontos de erro</b> sempre que você não seguir estas regras<br /><br />- Demasiados <b style='color:#A52A2A'>Erros</b> acumulados resultará teste <b style='color:#A52A2A'>falhado </b>",
            type = "alert",
            timeout = (15000),
            layout = "center",
            queue = "global"
...
Citizen.CreateThread(function()
    while true do
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "O veiculo está <b style='color:#B22222'>danificado!</b><br /><br />Observa!",
            type = "alert",
            timeout = (2000),
            layout = "bottomCenter",
            queue = "global"
		...
		elseif(IsControlJustReleased(1, 23)) and DamageControl == 1 then
			drawNotification("Não podes abandonar o veiculo até terminares o teste.")
    	end
	...
	if onTestEvent == 1 then
		if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), 255.13990783691,-1400.7319335938,29.5374584198, true) > 4.0001 then
		   DrawMarker(1,255.13990783691,-1400.7319335938,29.5374584198,0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 178, 236, 93, 155, 0, 0, 2, 0, 0, 0, 0)
			...
			N_0x80ead8e2e1d5d52e(onTestBlipp)
		    DrawMissionText2("Conduz até ao próximo ponto!", 5000)
			onTestEvent = 2
		end
	end
	...
	if onTestEvent == 3 then
		if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)),234.90780639648,-1345.3854980469, 29.542045593262, true) > 4.0001 then
		   DrawMarker(1,234.90780639648,-1345.3854980469, 29.542045593262,0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 178, 236, 93, 155, 0, 0, 2, 0, 0, 0, 0)
			...
			N_0x80ead8e2e1d5d52e(onTestBlipp)
			SetBlipRoute(onTestBlipp, 1)
		    DrawMissionText2("Faz uma ~r~paragem~s~ rápida para os civis ~y~atravessarem", 5000)
			...
			DrawMissionText2("~g~Boa!!~s~ Vamos andar!", 5000)
			onTestEvent = 4
		end
	end	
		...
		if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)),217.82102966309,-1410.5201416016,28.292112350464, true) > 4.0001 then
		   DrawMarker(1,217.82102966309,-1410.5201416016,28.292112350464,0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 178, 236, 93, 155, 0, 0, 2, 0, 0, 0, 0)
			...
			N_0x80ead8e2e1d5d52e(onTestBlipp)
			SetBlipRoute(onTestBlipp, 1)
		    DrawMissionText2("Faz uma ~r~paragem~s~ e observa a tua ~y~esquerda~s~ antes de entrares na via.", 5000)
			PlaySound(-1, "RACE_PLACED", "HUD_AWARDS", 0, 0, 1)
			FreezeEntityPosition(GetVehiclePedIsUsing(GetPlayerPed(-1)), true) -- Freeze Entity
			Citizen.Wait(6000)
			FreezeEntityPosition(GetVehiclePedIsUsing(GetPlayerPed(-1)), false) -- Freeze Entity
			DrawMissionText2("~g~Boa!~s~ Agora vira á ~y~direita~s~ e entra na faixa de rodagem", 5000)
			drawNotification("Area: ~y~Cidade\n~s~Limite de velocidade: ~y~80 km/h\n~s~Erros: ~y~".. Error.."/"..maxErrors)
			SpeedControl = 2
			onTestEvent = 5
			Citizen.Wait(4000)
		end
		...
		if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)),178.55052185059,-1401.7551269531,27.725154876709, true) > 4.0001 then
		   DrawMarker(1,178.55052185059,-1401.7551269531,27.725154876709,0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 178, 236, 93, 155, 0, 0, 2, 0, 0, 0, 0)
			...
			N_0x80ead8e2e1d5d52e(onTestBlipp)
			SetBlipRoute(onTestBlipp, 1)
		    DrawMissionText2("Observa o transito ~y~luzes~s~ !", 5000)
			onTestEvent = 6
		end
	end	
		...
		if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)),-73.542953491211,-1364.3355712891,27.789325714111, true) > 4.0001 then
		   DrawMarker(1,-73.542953491211,-1364.3355712891,27.789325714111,0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 178, 236, 93, 155, 0, 0, 2, 0, 0, 0, 0)
			...
			N_0x80ead8e2e1d5d52e(onTestBlipp)
			SetBlipRoute(onTestBlipp, 1)
		    DrawMissionText2("Certifica-te que paras para os veiculos passarem !", 5000)
			onTestEvent = 8
		end
	end			
		...
		if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)),-453.79092407227,-1444.7265625,27.665870666504, true) > 4.0001 then
		   DrawMarker(1,-453.79092407227,-1444.7265625,27.665870666504,0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 178, 236, 93, 155, 0, 0, 2, 0, 0, 0, 0)
			...
			N_0x80ead8e2e1d5d52e(onTestBlipp)
			SetBlipRoute(onTestBlipp, 1)
		    DrawMissionText2("Tempo para conduzir, tem cuidado para não batares !", 5000)
			PlaySound(-1, "RACE_PLACED", "HUD_AWARDS", 0, 0, 1)
		...
		if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)),1225.7598876953,-1948.7922363281,38.718940734863, true) > 4.0001 then
		   DrawMarker(1,1225.7598876953,-1948.7922363281,38.718940734863,0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 178, 236, 93, 155, 0, 0, 2, 0, 0, 0, 0)
			...
			N_0x80ead8e2e1d5d52e(onTestBlipp)
			SetBlipRoute(onTestBlipp, 1)
			DrawMissionText2("A entrar na cidade, cuidado com a velocidade!", 5000)
			drawNotification("~r~Abranda!\n~s~Area: ~y~Cidade\n~s~Limite de Velocidade: ~y~80 km/h\n~s~Erros: ~y~".. Error.."/"..maxErrors)
			onTestEvent = 15
		end
	end		
		...
		if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)),1163.6030273438,-1841.7713623047,35.679168701172, true) > 4.0001 then
		   DrawMarker(1,1163.6030273438,-1841.7713623047,35.679168701172,0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 178, 236, 93, 155, 0, 0, 2, 0, 0, 0, 0)
			...
			SetBlipRoute(onTestBlipp, 1)
			PlaySound(-1, "RACE_PLACED", "HUD_AWARDS", 0, 0, 1)
		    DrawMissionText2("Bom trabalho, vamos voltar agora para trás!", 5000)
			drawNotification("Area: ~y~Cidade\n~s~Limite de velocidade: ~y~80 km/h\n~s~Erros: ~y~".. Error.."/"..maxErrors)
			SpeedControl = 2
			onTestEvent = 16
		end
...
RegisterNUICallback('question', function(data, cb)
  SendNUIMessage({openSection = "Pergunta"})
  cb('ok')
end)
...
RegisterNUICallback('close', function(data, cb)
  ...
  closeGui()
  cb('ok')
  DrawMissionText2("~b~Teste teórico tirado com sucesso, estás agora apto para tirares o teste prático!", 2000)	
  theorylock = true
  testlock = false
  onTtest = false
end)
...
RegisterNUICallback('kick', function(data, cb)
  closeGui()
  cb('ok')
  DrawMissionText2("~r~Falhaste no teste, tenta novamente noutr altura", 2000)	
  onTtest = false
  theorylock = false
end)
...
Citizen.CreateThread(function()
    while true do
		...
		DrawMissionText2("~r~Estás a conduzir sem licença de condução", 2000)			
		end
	end
end)
...
Citizen.CreateThread(function()
    while true do
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "Estás a acelerar! <b style='color:#B22222'>Abranda!</b><br /><br />estás a conduzir numa zona de <b style='color:#DAA520'>50 km/h</b>!",
            type = "alert",
            timeout = (2000),
            layout = "bottomCenter",
            queue = "global"
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "Estás a acelerar! <b style='color:#B22222'>Abranda!</b><br /><br />estás a conduzir numa zona de <b style='color:#DAA520'>80 km/h</b>!",
            type = "alert",
            timeout = (2000),
            layout = "bottomCenter",
            queue = "global"
		...
		TriggerEvent("pNotify:SendNotification",{
            text = "Estás a acelerar! <b style='color:#B22222'>Abranda!</b><br /><br />estás a conduzir numa zona de <b style='color:#DAA520'>120 km/h</b>!",
            type = "alert",
            timeout = (2000),
            layout = "bottomCenter",
            queue = "global"
        ...
        if ( ped and inVehicle and DamageControl == 1 ) then
            if IsControlJustPressed(1, 73) then
                if (GetPedInVehicleSeat(vehicle, -1) == ped) then
                    if CruiseControl == 0 then
						...
						drawNotification("~y~Cruise Control: ~g~ligado\n~s~Velocidade máxima ".. math.floor(speedLimit*3.6).."km/h")
						Citizen.Wait(1000)
				        DisplayHelpText("Ajusta a tua velocidade máxima ~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ controlos")
						PlaySound(-1, "COLLECTED", "HUD_AWARDS", 0, 0, 1)
                        CruiseControl = 1
                    else
                        SetEntityMaxSpeed(vehicle, Max)
						drawNotification("~y~Cruise Control: ~r~desligado")						
                        CruiseControl = 0
                    end
                else
				    drawNotification("Precisas de estar a conduzir para ativares o Cruise Control")						
                end
            elseif IsControlJustPressed(1, 27) then
                if CruiseControl == 1 then
					...
					DisplayHelpText("Velocidade máxima ajustada para ".. math.floor(speedLimit*3.6).. "km/h")
                end
...
RegisterNUICallback('close', function(data, cb)
  ...
  closeGui()
  cb('ok')
  DrawMissionText2("~b~Teste tirado com sucesso, estás apto agora para tirares o teste prático", 2000)	
  theorylock = true
  testlock = false
  onTtest = false
end)
...
RegisterNUICallback('kick', function(data, cb)
    closeGui()
    cb('ok')
    DrawMissionText2("~r~Falhaste no exame, por favor tenta novamente noutra altura!", 2000)	
    onTtest = false
end)
	...
	while true do
		...
		for k,v in ipairs(dmvpedpos) do
			if(Vdist(v.x, v.y, v.z, pos.x, pos.y, pos.z) < 1.0)then
				DisplayHelpText("Carrega ~INPUT_CONTEXT~ para interagires com ~y~NPC")
				if(IsControlJustReleased(1, 38))then
						if talktodmvped then
						    Notify("~b~Bem vindo á escola de~h~Condução!")
						    Citizen.Wait(500)
							DMVMenu()
							Menu.hidden = false
							talktodmvped = false
...
function DMVMenu()
	ClearMenu()
    options.menu_title = "Escola de condução"
	Menu.addButton("Obtem a licença de condução","VehLicenseMenu",nil)
    Menu.addButton("Fechar","CloseMenu",nil) 
end

function VehLicenseMenu()
    ClearMenu()
    options.menu_title = "Licença de condução"
	Menu.addButton("Introdução    Gratis","startintro",nil)
	Menu.addButton("Teste Teórico    2000€","startttest",nil)
	Menu.addButton("Teste Prático    5000€","startptest",nil)
